...
<body>
     ...
     <div class="linea1"><p class="br">Infomacion del pedido</p></div> 
        ...
        <div class="linea1">
          <img src="imagenes/taj1.webp" alt="" width="90px" height="90px"> 
          <div class="j1"><p>TAJ AL MALIK 100ml</p>
              <p class="j3">$450,000,00</p>
            <p class="j3">Cantidad:1</p>
            <p class="j3">SKU: 85901034340919</p>
          </div>
        </div>

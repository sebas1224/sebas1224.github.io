...
<body>
     ...
     <div class="linea1"><p class="br">Infomacion del pedido</p></div> 
        ...
        <div class="linea1">
          <img src="imagenes/Fleur-1.jpg" alt="" width="90px" height="90px"> 
          <div class="j1"><p>Fleur De Orientica Eau De Parfum-90ml</p>
              <p class="j3">$$550,700,00</p>
            <p class="j3">Cantidad:1</p>
            <p class="j3">SKU: 40915901303489</p>
          </div>
        </div>

...
<body>
     ...
     <div class="linea1"><p class="br">Infomacion del pedido</p></div> 
        ...
        <div class="linea1">
          <img src="imagenes/lacoste.jpg" alt="" width="90px" height="90px"> 
          <div class="j1"><p>Perfume Lacoste L12 Rose Eau De Parfum - 90ml - Mujer </p>
              <p class="j3">$310,000,00</p>
            <p class="j3">Cantidad:1</p>
            <p class="j3">SKU: 7382241303489</p>
          </div>
        </div>

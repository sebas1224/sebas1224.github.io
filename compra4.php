...
<body>
     ...
     <div class="linea1"><p class="br">Infomacion del pedido</p></div> 
        ...
        <div class="linea1">
          <img src="imagenes/orientica-amber-noir.webp" alt="" width="90px" height="90px"> 
          <div class="j1"><p>Orientica Amber Noir 75ml</p>
              <p class="j3">$160,000,00</p>
            <p class="j3">Cantidad:1</p>
            <p class="j3">SKU: 123401303489</p>
          </div>
        </div>

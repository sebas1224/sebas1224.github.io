...
<body>
     ...
     <div class="linea1"><p class="br">Infomacion del pedido</p></div> 
        ...
        <div class="linea1">
          <img src="imagenes/sakeena-2.webp" alt="" width="90px" height="90px"> 
          <div class="j1"><p>Lattafa Sakeena 100 ML</p>
              <p class="j3">$395,000,00</p>

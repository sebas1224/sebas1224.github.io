...
<body>
     ...
     <div class="linea1"><p class="br">Infomacion del pedido</p></div> 
        ...
        <div class="linea1">
          <img src="imagenes/armani.webp" alt="" width="90px" height="90px"> 
          <div class="j1"><p>Armani Code Parfum 100 ML</p>
              <p class="j3">$430,000,00</p>
            <p class="j3">Cantidad:1</p>
            <p class="j3">SKU: 56433401303489</p>
          </div>
        </div>

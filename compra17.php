...
<body>
     ...
     <div class="linea1"><p class="br">Infomacion del pedido</p></div> 
        ...
        <div class="linea1">
          <img src="imagenes/by1.jfif" alt="" width="90px" height="90px"> 
          <div class="j1"><p>perfume S by Shakira EDT 80 Ml</p>
              <p class="j3">$170,000,00</p>

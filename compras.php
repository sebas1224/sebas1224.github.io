...
<body>
     ...
     <div class="linea1"><p class="br">Infomacion del pedido</p></div> 
        ...
        <div class="linea1">
          <img src="imagenes/only1.webp" alt="" width="90px" height="90px"> 
          <div class="j1"><p>Perfume Only The Brave Street De Diesel Para Hombre 125 ml</p>
              <p class="j3">$260,000,00</p>
            <p class="j3">Cantidad:1</p>
            <p class="j3">SKU: 956901303489</p>
          </div>
        </div>

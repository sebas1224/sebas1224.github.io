...
<body>
     ...
     <div class="linea1"><p class="br">Infomacion del pedido</p></div> 
        ...
        <div class="linea1">
          <img src="imagenes/ara1.webp" alt="" width="90px" height="90px"> 
          <div class="j1"><p>ASAD, LATTAFA 100 Ml</p>
              <p class="j3">$370,000,00</p>
            <p class="j3">Cantidad:1</p>
            <p class="j3">SKU: 59013409103489</p>
          </div>
        </div>

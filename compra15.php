...
<body>
     ...
     <div class="linea1"><p class="br">Infomacion del pedido</p></div> 
        ...
        <div class="linea1">
          <img src="imagenes/royal1.webp" alt="" width="90px" height="90px"> 
          <div class="j1"><p>Luxury Royal Amber   80ml</p>
              <p class="j3">$670,000,00</p>

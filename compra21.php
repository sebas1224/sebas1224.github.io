...
<body>
     ...
     <div class="linea1"><p class="br">Infomacion del pedido</p></div> 
        ...
        <div class="linea1">
          <img src="imagenes/ede1.webp" alt="" width="90px" height="90px"> 
          <div class="j1"><p>BOSS THE SCENT FOR HER - Eau de Parfum para Mujer 100ml</p>
              <p class="j3">$400,000,00</p>
            <p class="j3">Cantidad:1</p>
            <p class="j3">SKU: 09198059103434</p>
          </div>
        </div>

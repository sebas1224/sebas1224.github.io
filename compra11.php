...
<body>
     ...
     <div class="linea1"><p class="br">Infomacion del pedido</p></div> 
        ...
        <div class="linea1">
          <img src="imagenes/divine.webp" alt="" width="90px" height="90px"> 
          <div class="j1"><p>ESTUCHE JEAN PAUL GAULTIER DIVINE EDP,750 ML- Mujer <p class="j3">$920,000,00</p><p class="j3">Cantidad:1</p><p class="j3">SKU: 6085010239619</p></p></div>
        </div>

...
<body>
     ...
     <div class="linea1"><p class="br">Infomacion del pedido</p></div> 
        ...
        <div class="linea1">
          <img src="imagenes/haya1.png" alt="" width="90px" height="90px"> 
          <div class="j1"><p>Árabe Hayaati 100 Ml</p>
              <p class="j3">$350,000,00</p>
            <p class="j3">Cantidad:1</p>
            <p class="j3">SKU: 03485901340919</p>
          </div>
        </div>

...
<body>
     ...
     <div class="linea1"><p class="br">Infomacion del pedido</p></div> 
        ...
        <div class="linea1">
          <img src="imagenes/ameerat2.jpg" alt="" width="90px" height="90px"> 
          <div class="j1"><p>Asdaaf Ameerat Al Arab 100 ML</p>
              <p class="j3">$179,700,00</p>
            <p class="j3">Cantidad:1</p>
            <p class="j3">SKU: 89433401303489</p>
          </div>
        </div>

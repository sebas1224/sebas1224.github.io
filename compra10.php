...
<body>
     ...
     <div class="linea1"><p class="br">Infomacion del pedido</p></div> 
        ...
        <div class="linea1">
          <img src="imagenes/club.jfif" alt="" width="90px" height="90px"> 
          <div class="j1"><p>CLUB DE NUIT WOMAN EDP SP, ARMAF, COD. MAF-002,105 ML- Mujer <p class="j3">$260,000,00</p><p class="j3">Cantidad:1</p><p class="j3">SKU: 6085010094151</p></p></div>
        </div>

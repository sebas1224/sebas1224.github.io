...
<body>
     ...
     <div class="linea1"><p class="br">Infomacion del pedido</p></div> 
        ...
        <div class="linea1">
          <img src="imagenes/negra.jpg" alt="" width="90px" height="90px"> 
          <div class="j1"><p>PERFUME BOSS BOTTLED PARFUM 100 ML</p>
              <p class="j3">$520,000,00</p>
